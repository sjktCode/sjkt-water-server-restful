...
export class ScheduleService {
    ...
    async create(entity: DeepPartial<Schedule>): Promise<boolean> {
        const res = await this.scheduleRepository.save(this.scheduleRepository.create(entity));
        if (res) {
            return true;
        }
        return false;
    ...
    async findAllSchedules({
        ...
        return this.scheduleRepository.findAndCount({
            ...
            relations: ['course', 'course.teachers', 'scheduleRecords', 'scheduleRecords.student'],
        });
    }
